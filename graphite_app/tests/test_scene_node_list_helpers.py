...
graphite_scene.py already defined _all_conversational_nodes()/_all_content_nodes()/
...
class TestUpdateConnectionsUsesConversationalPlusContentNodes:
    def test_a_connection_between_two_tracked_plugin_nodes_survives(self):
        ...
        from graphite_plugins.graphite_plugin_artifact import ArtifactConnectionItem
