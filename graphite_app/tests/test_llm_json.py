...
graphite_plugin_code_review.py, graphite_plugin_quality_gate.py,
graphite_plugin_workflow.py, and graphite_plugin_gitlink.py each independently
...
class TestCallLlmAndParseJson:
    def test_returns_parsed_json_from_chat_response(self):
        ...
        with patch("graphite_plugins.common.llm_json.api_provider.chat", return_value=fake_response) as mock_chat:
    ...
    def test_handles_fenced_json_in_the_response(self):
        ...
        with patch("graphite_plugins.common.llm_json.api_provider.chat", return_value=fake_response):
    ...
    def test_propagates_exceptions_from_the_chat_call(self):
        with patch("graphite_plugins.common.llm_json.api_provider.chat", side_effect=RuntimeError("network down")):
