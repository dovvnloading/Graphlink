"""Tests for graphite_logging.configure_logging().
...
class TestConfigureLogging:
    ...
    def test_default_path_is_under_the_graphlink_home_directory(self, monkeypatch, tmp_path):
        ...
        graphite_logging.configure_logging()
