    ...
    SECTION_DEFS = [
        (
            ...
            [
                ...
                ("Start or Resume", "Open a recent project from the Library, or press Ctrl+T to start a new chat. The app is comfortable for quick ideation and for returning to long-running work.", "fa5s.play-circle"),
