...
directly from the specific submodule it needs (e.g. `from graphlink_plugins.
graphlink_plugin_artifact import ArtifactNode`), and eagerly importing every plugin
...
module (e.g. graphlink_plugin_context_menu.py depends on nothing plugin-specific, but
