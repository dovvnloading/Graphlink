...
detect drift, though: `python codegen.py --check` (see
...
GENERATED_ARTIFACTS = [
    {
        ...
        "source": "contracts/graphlink_token_counter_payload.py::TokenCounterStatePayload",
    ...
    },
    {
        ...
        "source": "contracts/graphlink_notification_payload.py::NotificationStatePayload",
    ...
    },
    {
        ...
        "source": "contracts/graphlink_grid_control_payload.py::GridControlStatePayload",
    ...
    },
    {
        ...
        "source": "contracts/graphlink_font_control_payload.py::FontControlStatePayload",
    ...
    },
    {
        ...
        "source": "contracts/graphlink_drag_speed_payload.py::DragSpeedStatePayload",
    ...
    },
    {
        ...
        "source": "contracts/graphlink_app_composer_payload.py::AppComposerStatePayload",
    ...
    },
    {
        ...
        "title": "AppAboutState",
        "source": "contracts/graphlink_app_about_payload.py::AppAboutStatePayload",
    ...
    },
    {
        ...
        "source": "contracts/graphlink_app_plugins_payload.py::AppPluginsStatePayload",
    ...
    },
    {
        ...
        "source": "contracts/graphlink_app_settings_payload.py::AppSettingsStatePayload",
    ...
    },
    {
        ...
        "source": "contracts/graphlink_app_chat_library_payload.py::AppChatLibraryStatePayload",
...
def api_contract_ts() -> str:
    ...
    lines = [
        _HEADER.format(source="contracts/codegen.py::GENERATED_ARTIFACTS"),
        "",
    ]
...
def _main(argv: list[str]) -> int:
    """CLI entry point: `python codegen.py [--check | --write]`.
    ...
    if mode not in ("--check", "--write"):
        print(f"usage: python codegen.py [--check | --write], got {mode!r}", file=sys.stderr)
        return 2
