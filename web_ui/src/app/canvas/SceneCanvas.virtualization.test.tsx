  ...
  return {
    ...(Object.fromEntries(
      Object.entries({
        ...
        codeReviewPrUrl: "", codeReviewRepo: "", codeReviewPrNumber: 0,
        codeReviewPrTitle: "", codeReviewPrState: "", codeReviewPrHtmlUrl: "",
        codeReviewBaseRef: "", codeReviewHeadRef: "", codeReviewAdditions: 0,
        codeReviewDeletions: 0, codeReviewChangedFiles: 0, codeReviewFiles: [],
        codeReviewFilesTruncated: false, codeReviewDiffTruncated: false,
        codeReviewDiffChars: 0, codeReviewDiffVersion: 0, codeReviewWalkthrough: [],
        codeReviewFindings: [], codeReviewErrors: [], codeReviewDismissedIds: [],
        codeReviewTitle: "", codeReviewOverview: "", codeReviewConfidence: "",
        codeReviewScores: {}, codeReviewQualityScore: 0, codeReviewVerdict: "none",
        codeReviewRisk: "", codeReviewQualitySummary: "", codeReviewQa: [],
        codeReviewState: "draft", codeReviewError: "",
