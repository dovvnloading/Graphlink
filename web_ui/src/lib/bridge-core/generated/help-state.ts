/* GENERATED - do not hand-edit. Source of truth: graphlink_app/graphlink_help_payload.py::HelpStatePayload.
...
function checkHelpState(value: unknown, path: string, errors: string[]): void {
...
export function validateHelpState(value: unknown): ValidationResult<HelpState> {
  const errors: string[] = [];
  checkHelpState(value, "$", errors);
  return errors.length === 0
    ? { ok: true, value: value as HelpState }
    : { ok: false, errors };
}
