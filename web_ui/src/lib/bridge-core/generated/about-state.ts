/* GENERATED - do not hand-edit. Source of truth: graphlink_app/graphlink_about_payload.py::AboutStatePayload.
...
function checkAboutState(value: unknown, path: string, errors: string[]): void {
...
export function validateAboutState(value: unknown): ValidationResult<AboutState> {
  const errors: string[] = [];
  checkAboutState(value, "$", errors);
  return errors.length === 0
    ? { ok: true, value: value as AboutState }
    : { ok: false, errors };
}
